...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if(!closedState) {
			...
			var http = new haxe.Http("https://raw.githubusercontent.com/ninjaninja140/DylanEngine/main/gitVersion.txt");
			
			http.onData = function (data:String)
			{
				updateVersion = data.split('\n')[0].trim();
				var curVersion:String = MainMenuState.dEngineVersion.trim();
		...
		FlxG.save.bind('DEngine', 'ninjaninja140');
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 3:
					...
					addMoreText('and', 45);
					addMoreText('Modded by dylank', 45);
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(['Dylan is pretty cool'], -60);
				case 7:
					addMoreText('ig', -60);
				...
				case 13:
					addMoreText('Dylan'); // credTextShit.text += '\nFunkin';
				case 14:
					skipIntro();
			}
		}
